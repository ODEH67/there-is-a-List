...
export default function Popup() {
  ...
  const handleClick = () => {
    if (email.current.value === process.env.REACT_APP_EMAIL && password.current.value ===  process.env.REACT_APP_PASS) {
      localStorage.setItem('emailData',  process.env.REACT_APP_EMAIL);
      localStorage.setItem('passwordData', process.env.REACT_APP_PASS);
    }
  };
